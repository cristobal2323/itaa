...
/* Config setting */
export function resetAddTrabajadorEmpresa() {
  return {
    type: RESET_LIST_TRABAJADOR_EMPRESA_INFO
  };
}
...
function fetchApiSuccess(data) {
  return {
    type: FETCH_LIST_TRABAJADOR_EMPRESA_INFO_SUCCESS,
    payload: data
  };
}
...
function fetchApiFailure(error) {
  return {
    type: FETCH_LIST_TRABAJADOR_EMPRESA_INFO_FAILURE
  };
}

function fetchApiInit() {
  return {
    type: FETCH_LIST_TRABAJADOR_EMPRESA_INFO_INIT
  };
}

export function fetchTrabajadorEmpresaInfoApi(data) {
