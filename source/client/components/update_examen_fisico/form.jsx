...
const Form = props => (
  <form onSubmit={props.handleSubmit}>
    <section className="form">
      ...
      <div className="top">
        <label htmlFor="enfermedadCardiacas">Enfermedades cardiacas</label>
        <select
          name="enfermedadCardiacas"
          id="enfermedadCardiacas"
          onChange={props.handleChange}
          value={props.form.enfermedadCardiacas}
        >
